...
#ifndef PopulationClassicRule_hpp
#define PopulationClassicRule_hpp
#include "ClassicRule.hpp"

class PopulationClassicRule : public ClassicRule {
public:
...
#endif /* PopulationClassicRule_hpp */
